...
const Art = () => {
    ...
    useGSAP(() => {
        ...
        maskTimeline
          ...
          .to(".masked-img", {scale: 1.3, ease: "power1.inOut", duration: 1, maskPosition: "center", maskSize: "400%"})
          .to(".masked-content", {opacity: 1, duration: 1, ease: "power1.inOut"})
    })

  return (
    <div id="art" className="lg:px-5">
        <div className="mx-auto container h-full pt-20">
            ...
            <div className="content ">
                ...
                <div className="cocktail-img">
                    <img src="/images/under-img.jpg" alt="cocktail img"
